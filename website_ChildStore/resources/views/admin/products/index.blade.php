                ...
                <tbody>
                    @foreach ($products as $item)
                        <tr>
                            ...
                            <td style="padding: 7px 26px">{{ $item->category->name }}</td>
                            ...
                            <td>
                                <a href="{{ url('edit-products',$item->id) }}" class="btn btn-primary">Sửa</a>
                                <a href="{{ url('delete-products',$item->id) }}" class="btn btn-danger">Xoá</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
